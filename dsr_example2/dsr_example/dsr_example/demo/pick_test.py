...
def main(args=None):
        ...
        # Gripping pose
        x1= posx(300, -350, 190.0, 0.0, 180.0, 0.0)
        
        # Going to release pose
        x2= posx(300, -350, 290.0, 0.0, 180.0, 0.0)
        x3 = posx(300, 210, 330.0, 0.0, 180.0, 0.0)
        x4 = posx(300, 550, 300, 0, 180, 0)
        xlist = [x2, x3, x4]

        # # Gripping pose
        # x1= posx(500, 0.0, 0.0, 0.0, 180.0, 0.0)
        
        # # Going to release pose
        # x2= posx(500, 0.0, 0.0, 0.0, 180.0, 0.0)
        # x3 = posx(500, 210, 330.0, 0.0, 180.0, 0.0)
        # x4 = posx(500, 550, 300, 0, 180, 0)
        # xlist = [x2, x3, x4]
